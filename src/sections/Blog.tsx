...
const Blog = () => {
  const blogs = [
  {
    ...
    url: 'https://yourblog.com/react-scalable-guide'
  },
  {
    ...
    url: 'https://yourblog.com/ai-web-future'
  },
  {
    ...
    url: 'https://yourblog.com/typescript-tips'
  },
  {
  ...
  return (
    ...
    className="block bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300"
  >
